...
export const artists: Array<IArtist> = [
    ...
    },
    {
        ...
        website: 'https://katefetherston.com',
        bio: [
            'Raised in New Mexico, Kate Fetherston migrated to northern California for many years before relocating to Vermont in 1998. Her work is influenced by the light and seasons of three river valleys---the Rio Grande, the Sacramento, and the Winooski. Kate\'s interest is in the interactive nature of being-and-seeing connected to time and place. Her congenital visual impairment brings with it a sensitivity to the creative and quixotic nature of seeing. The Japanese aesthetic of wabi-sabi with its emphasis on imperfection and the fleeting, bittersweet nature of life is a guiding principle in Kate\'s work.',
            'Kate\'s academic background is in music, philosophy, women\'s studies, and poetry. She has a B.A. in Philosophy, and an MSW. Kate is a clinical social worker in private practice.  She holds an MFA in poetry from Vermont College of Fine Arts.',
            'Kate is the author of two books of poems, <u>Until Nothing More Can Break</u> and <u>This Far from Perfect</u>. She co-edited two anthologies, <u>Manthology</u>, and <u>Open Book</u>. Her writing has appeared in numerous journals, including <em>North American Review</em>, <em>Nimrod</em>, and <em>Hunger Mountain</em>.  Kate\'s received numerous Pushcart nominations, as well as grants from Vermont Council on the Arts and residencies at Vermont Studio Center for both poetry and visual art. ',
            'Kate has studied privately with artists around the country. Her visual art has shown in solo and group shows throughout Vermont. Kate\'s work is in private collections in the United States and Canada.'
        ]
    },
    {
